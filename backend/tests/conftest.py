...
def operation_test_keys(monkeypatch):
    # Test-only key. Production keys are generated by scripts/configure_security.py.
    monkeypatch.setattr(settings, "operation_signing_keys", '{"test":"' + "ab" * 32 + '"}')
    monkeypatch.setattr(settings, "operation_active_key_id", "test")
